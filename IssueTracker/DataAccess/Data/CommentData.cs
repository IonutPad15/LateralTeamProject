...
namespace DataAccess.Data
{
    public class CommentData : ICommentData
    {
        ...
        public async Task<Comment?> GetByIdAsync(int id) =>
            (await _db.LoadDataAsync<Comment, dynamic>("dbo.spComment_Get", new { Id = id })).FirstOrDefault();
        public async Task<IEnumerable<Comment>> GetAllByUserIdAsync(Guid id) =>
            (await _db.LoadDataAsync<Comment, dynamic>("dbo.spComment_GetAllByUserId", new { UserId = id }));
        public async Task<IEnumerable<Comment?>> GetAllByIssueIdAsync(int id) =>
            (await _db.LoadDataAsync<Comment, dynamic>("dbo.spComment_GetAllByIssueId", new { IssueId = id }));
        public async Task<IEnumerable<Comment?>> GetAllByCommentIdAsync(int id) =>
            (await _db.LoadDataAsync<Comment, dynamic>("dbo.spComment_GetAllByCommentId", new { CommentId = id }));
