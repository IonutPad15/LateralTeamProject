...
public class IssueDataTest : BaseClass
{
    ...
    {
        var issueList = await TestIssueRepository.GetAllAsync();
    ...
    {
        await Assert.ThrowsExceptionAsync<SqlException>(() => TestIssueRepository.GetByIdAsync(0));
    }
    ...
    {
        var issue = await TestIssueRepository.GetByIdAsync(1);
    ...
    public async Task Updated()
    {
        ...
        await TestIssueRepository.UpdateAsync(issue);
        Assert.IsTrue(true);
    }
    ...
    public async Task Updated_EntityWithoutTitle_Error()
    {
        ...
        await Assert.ThrowsExceptionAsync<SqlException>(() => TestIssueRepository.UpdateAsync(issue));
    }
}
