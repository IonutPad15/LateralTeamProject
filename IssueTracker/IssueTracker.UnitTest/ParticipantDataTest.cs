...
public class ParticipantDataTest : BaseClass
{
    ...
    public async Task AddAsync_Test()
    {
        ...
        var participantId = await ParticipantRepository.AddAsync(participant);
        //act
        var result = await ParticipantRepository.GetByIdAsync(participantId);
        //assert
    ...
    {
        await ParticipantRepository.DeleteAsync(2);
    }
    [TestMethod]
    ...
    {
        var participant = await ParticipantRepository.GetByIdAsync(1);
    ...
    {
        var participant = await ParticipantRepository.GetByIdAsync(0);
    ...
    {
        var participants = await ParticipantRepository.GetOwnersAndCollabsByProjectIdAsync(1);
    ...
    {
        var participants = await ParticipantRepository.GetOwnersAndCollabsByProjectIdAsync(0);
        Assert.IsTrue(!participants.Any());
    }
    [TestMethod]
    ...
    {
        var participants = await ParticipantRepository.GetOwnerByProjectIdAsync(1);
    ...
    {
        var participants = await ParticipantRepository.GetOwnerByProjectIdAsync(0);
        Assert.IsTrue(participants.Count() != 1);
    }
    [TestMethod]
